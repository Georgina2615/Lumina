...
export default function PublicBookingPaymentStep({
  ...
  return (
    <section aria-labelledby="booking-payment-title">
      ...
      <h2 className="mt-2 text-3xl" id="booking-payment-title">Paga tu anticipo</h2>
      <p className="mt-3 text-sm leading-6 text-muted">Tu horario se reservará mientras completas el pago seguro.</p>

      <div className="mt-7 overflow-hidden rounded-3xl bg-primary text-surface">
        <div className="flex flex-wrap items-start justify-between gap-4 border-b border-surface/15 p-6 sm:p-7">
          <div>
        ...
        <div className="grid gap-4 p-6 text-sm sm:grid-cols-2 sm:p-7">
