...
const privacySections = [
  {
    ...
    paragraphs: [
      'Lumina Skin con domicilio en Avenida Adolfo López Mateos 426 Campeche Campeche es responsable del tratamiento de los datos proporcionados dentro de este prototipo académico',
      'Las solicitudes relacionadas con privacidad pueden enviarse a luminask01@gmail.com'
    ]
  },
  {
    id: 'datos',
    title: 'Datos que podemos utilizar',
    paragraphs: ['Solo solicitamos información relacionada con la atención estética y la operación de la cita'],
    items: [
  ...
  },
  {
    ...
    paragraphs: [
      'La ficha técnica el seguimiento las fotografías y el consentimiento informado pueden revelar información sensible sobre la salud o condición de la piel',
      'Estos datos se utilizan únicamente para prestar y documentar la atención estética y requieren una autorización expresa dentro del flujo clínico'
    ]
  },
  {
    id: 'finalidades',
    title: 'Para qué utilizamos los datos',
    paragraphs: ['Las finalidades necesarias para operar Lumina Skin son las siguientes'],
    items: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Lumina Skin limita el acceso a la información según las actividades de cada integrante del personal y utiliza medidas de seguridad para evitar consultas cambios o usos no autorizados'
    ]
  },
  {
    id: 'derechos',
    ...
    paragraphs: [
      'Puedes solicitar acceso corrección eliminación u oposición al uso de tus datos y retirar autorizaciones opcionales mediante un correo a luminask01@gmail.com con tu nombre medio de contacto y una descripción clara de la solicitud',
  ...
  },
  {
    ...
    paragraphs: [
      'Lumina Skin es un prototipo académico creado por Joely Balam Reyes y este documento presenta el tratamiento de datos previsto para su demostración',
