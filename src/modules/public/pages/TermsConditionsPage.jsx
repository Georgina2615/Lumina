...
const termsSections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'La clienta deberá proporcionar información verdadera y actualizada para poder recibir avisos y preparar su atención de forma adecuada'
    ]
  },
  {
    id: 'reservacion',
    ...
    paragraphs: [
      ...
      'En las citas solicitadas por internet el pago se realizará mediante transferencia y el horario quedará confirmado cuando recepción revise el comprobante',
